...
```r
ggplot(DF, aes(Data_Set, steps)) + geom_boxplot(color = "darkblue", fill = "green") + theme_update() +
...
plot4 <- ggplot(Average_by_interval3, aes(Interval, Steps, color = Weekday)) + geom_line(size = 1) + 
